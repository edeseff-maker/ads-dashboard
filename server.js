...
const META_TOKEN = 'EAAfBRFVy6OUBRfKZBfB4MCTnp9cfReTZA0WhMeNaQ7h2Qa9ntX1yTTXTFhmfb9jGWvYA7xHLRzTWLxlWCPQArhBUvaNjkzMtSukN9p40qwcB6MAAU1nSeswoyDfmKyRxxtjZCr9gjodFoVh8IiXPKnuYIYhCvlNqOysxLj7aQQaYkENGlwGDoNdUcd73wZDZD';
const META_ACCOUNT = 'act_881641562970222';

const COUNTRY_NAMES = {
  'AR':'Argentina','BO':'Bolivia','CL':'Chile','CO':'Colombia',
  'EC':'Ecuador','PY':'Paraguay','PE':'Peru','UY':'Uruguay',
  'VE':'Venezuela','MX':'México','BR':'Brasil','US':'Estados Unidos'
};
...
const server = http.createServer((req, res) => {
  ...
  if (path === '/' || path === '') {
    ...
    if (!customer_id) { res.writeHead(400, {'Content-Type': 'application/json'}); res.end(JSON.stringify({ error: 'Falta customer_id' })); return; }
